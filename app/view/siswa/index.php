    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-6">
              <?php Flasher::flash(); ?>
                <button type="button" class="btn btn-primary mb-3 tombolTambahData" data-bs-toggle="modal" data-bs-target="#formModal">Tambah Data Siswa</button>
                <h3>Data Siswa</h3>
                    <ul class="list-group">
                        <?php foreach ($data['siswa'] as $siswa) : ?>
                        <li class="list-group-item">
                            <?php echo $siswa['nama']; ?>
                            <a href="<?= BASE_URL; ?>/siswa/hapus/<?= $siswa['id']; ?>" class="btn btn-danger btn-sm float-end m-1" onclick="return confirm('Yakin Ingin Menghapus?');">Hapus</a>
                            <a href="<?= BASE_URL; ?>/siswa/ubah/<?= $siswa['id']; ?>" class="btn btn-success btn-sm float-end m-1 tampilModalUbah" data-bs-toggle="modal"
