<div class="container">
<div class="card mt-5 rounded-0 border-0" style="max-width: 100%;">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="<?php echo BASE_URL; ?>/img/DPIB.jpg" class="img-fluid rounded-0" alt="img" style="height: 370px; width: 400px;">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h3 class="card-title mb-3">Desain Pemodelan dan Informasi Bangunan</h3>
              <p class="card-text">Desain Pemodelan dan Informasi Bangunan (DPIB) adalah salah satu jurusan yang mempelajari tentang perencanaan bangunan, pelaksanakan pembuatan gedung, perbaikan gedung, dan lain sebagainya.</p>
            </div>
          </div>
        </div>
</div>
